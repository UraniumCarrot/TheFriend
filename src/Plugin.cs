...
namespace TheFriend
{
    ...
    class Plugin : BaseUnityPlugin
    {
        ...
        public void OnEnable()
        {
            ...
            //_ = SLOracleHandler.SLOracleFriendBehaviors.GiveMark;
        ...
        // Makes Poacher get cold faster, Poacher food preferences, and riding lizards
        public void Player_Update(On.Player.orig_Update orig, Player self, bool eu)
        {
            ...
            // Friend jumps
            if (self.slugcatStats.name == FriendName && self.animation != ind.RocketJump && self.GetPoacher().HighJumped) self.GetPoacher().HighJumped = false;
        }
        ...
        public void Player_GraphicsModuleUpdated(On.Player.orig_GraphicsModuleUpdated orig, Player self, bool actuallyViewed, bool eu)
        {
            ...
            catch (Exception) { Debug.Log("Solace: Exception occurred in Player.GraphicsModuleUpdated"); }
        }
        ...
        // Implement improved sleepscreen
